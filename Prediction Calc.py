...
with open('GB_RC_rf.pkl', 'rb') as file:
    GB_RC_rf = pickle.load(file)

with open('DE_RC_rf.pkl', 'rb') as file:
    DE_RC_rf = pickle.load(file)

with open('JP_RC_rf.pkl', 'rb') as file:
    JP_RC_rf = pickle.load(file)

with open('US_RC_rf.pkl', 'rb') as file:
    US_RC_rf = pickle.load(file)

with open('GB_NC_rf.pkl', 'rb') as file:
    GB_NC_rf = pickle.load(file)

with open('DE_NC_rf.pkl', 'rb') as file:
    DE_NC_rf = pickle.load(file)

with open('JP_NC_rf.pkl', 'rb') as file:
    JP_NC_rf = pickle.load(file)

with open('US_NC_rf.pkl', 'rb') as file:
    US_NC_rf = pickle.load(file)
...
test_GB_NC_new['prediction'] = GB_NC_rf.predict_proba(test_GB_NC.drop(['order_number', 'order_date', 'locale_key', 'order_frequency', 'order_sequence_no', 'Flash_Ind', 'Singles_Ind', 'Golden_Week_Ind'], axis=1))[:,1]
test_DE_NC_new['prediction'] = DE_NC_rf.predict_proba(test_DE_NC.drop(['order_number', 'order_date', 'locale_key', 'order_frequency', 'order_sequence_no', 'Flash_Ind', 'Singles_Ind', 'Golden_Week_Ind'], axis=1))[:,1]
test_JP_NC_new['prediction'] = JP_NC_rf.predict_proba(test_JP_NC.drop(['order_number', 'order_date', 'locale_key', 'order_frequency', 'order_sequence_no'], axis=1))[:,1]
test_US_NC_new['prediction'] = US_NC_rf.predict_proba(test_US_NC.drop(['order_number', 'order_date', 'locale_key', 'order_frequency', 'order_sequence_no', 'Flash_Ind', 'Singles_Ind', 'Golden_Week_Ind'], axis=1))[:,1]

test_GB_RC_new['prediction'] = GB_RC_rf.predict_proba(test_GB_RC.drop(['order_number', 'order_date', 'locale_key', 'Flash_Ind', 'Singles_Ind', 'Golden_Week_Ind'], axis=1))[:,1]
test_DE_RC_new['prediction'] = DE_RC_rf.predict_proba(test_DE_RC.drop(['order_number', 'order_date', 'locale_key', 'Flash_Ind', 'Singles_Ind', 'Golden_Week_Ind'], axis=1))[:,1]
test_JP_RC_new['prediction'] = JP_RC_rf.predict_proba(test_JP_RC.drop(['order_number', 'order_date', 'locale_key'], axis=1))[:,1]
test_US_RC_new['prediction'] = US_RC_rf.predict_proba(test_US_RC.drop(['order_number', 'order_date', 'locale_key', 'Flash_Ind', 'Singles_Ind', 'Golden_Week_Ind'], axis=1))[:,1]



dfs = [test_GB_NC_new, test_GB_RC_new, test_DE_NC_new, test_DE_RC_new, test_JP_NC_new, test_JP_RC_new, test_US_NC_new, test_US_RC_new]
