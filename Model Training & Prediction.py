...
with open(r'S:\Nutrition_Data\Nutrition_Data\Data_Pipelines\Nutrition_Data_Retention_Model\GB_RC_rf.pkl', 'rb') as file:
    GB_RC_rf = pickle.load(file)

with open(r'S:\Nutrition_Data\Nutrition_Data\Data_Pipelines\Nutrition_Data_Retention_Model\DE_RC_rf.pkl', 'rb') as file:
    DE_RC_rf = pickle.load(file)

with open(r'S:\Nutrition_Data\Nutrition_Data\Data_Pipelines\Nutrition_Data_Retention_Model\JP_RC_rf.pkl', 'rb') as file:
    JP_RC_rf = pickle.load(file)

with open(r'S:\Nutrition_Data\Nutrition_Data\Data_Pipelines\Nutrition_Data_Retention_Model\US_RC_rf.pkl', 'rb') as file:
    US_RC_rf = pickle.load(file)

with open(r'S:\Nutrition_Data\Nutrition_Data\Data_Pipelines\Nutrition_Data_Retention_Model\GB_NC_rf.pkl', 'rb') as file:
    GB_NC_rf = pickle.load(file)

with open(r'S:\Nutrition_Data\Nutrition_Data\Data_Pipelines\Nutrition_Data_Retention_Model\DE_NC_rf.pkl', 'rb') as file:
    DE_NC_rf = pickle.load(file)

with open(r'S:\Nutrition_Data\Nutrition_Data\Data_Pipelines\Nutrition_Data_Retention_Model\JP_NC_rf.pkl', 'rb') as file:
    JP_NC_rf = pickle.load(file)

with open(r'S:\Nutrition_Data\Nutrition_Data\Data_Pipelines\Nutrition_Data_Retention_Model\US_NC_rf.pkl', 'rb') as file:
